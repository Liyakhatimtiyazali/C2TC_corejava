...
//-------------------------------------------------------withdraw()
	...
	public void withdraw(float withdrawalAmount) {
		...
		if(isSalaried()) {
			...
			// If isSalaried is true MINBAL will not be considered
