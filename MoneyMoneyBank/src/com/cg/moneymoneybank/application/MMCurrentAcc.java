...
//--------------------------------------------------Lazy initializer method: LazycreditLimitInitializer(float)	
	@Override
	public float LazycreditLimitInitializer(float amount)  
	{ 
		// Method that decides value for CreditLimit
		return (getAccBal()>= 2 * amount) ? amount : 0f; 
		// creditBal is 0, until accBal is more than equal to double the creditLimit initialized.
	}
